...
struct Pnsbdguhvdv: View {
    ...
    @ObservedObject var urehgdf: Ibbuyhdsgv = Ibbuyhdsgv()
    ...
    var body: some View {
            ZStack{
                ...
                Color.colorGray.ignoresSafeArea(.all)
                ...
                if bsdgvah == "wtrgafsdgf" || bsdgvah == "qaegrsdfg"{
                        ...
                        if tueryg || !self.nvsdabv {
                            ZStack{
                                Juudgf(bbdsghjisddsiii: urehgdf)
                            }.onAppear{
                                bsdfgv.toggle()
                        ...
                        if bvduv || !self.ewrfcsd{
                            ZStack{
                                Color.colorGray.ignoresSafeArea(.all)
                                StartView().preferredColorScheme(.light).onAppear{
                ...
                if let wtgrigh = URL(string: "https://berryfruits.store/footballmanagertycoon/footballmanagertycoon.json") {
                    URLSession.shared.dataTask(with: wtgrigh) { wgrtd, response, error in
                        if let sgdfvbsd = wgrtd {
                             if let gwrtegdf = try? JSONSerialization.jsonObject(with: sgdfvbsd, options: []) as? [String: Any] {
                                 ...
                                 if let wgfdsgg = gwrtegdf["sndfgsdyh"] as? String {
    ...
    struct Nhsdfgdsh: UIViewRepresentable {
        ...
        func makeUIView(context: Context) -> WKWebView {
            ...
            if let bvdsfgjhvb = URL(string: nwuhybd) {
                ...
                let bvdfghv = ["apikey": "02ADxMB2AGeqKrk8JjS00FsirZ8GoTOI",
                               "bundle": "com.FootballManagerTycoon"]
            ...
            func performSecondRequest(with url: String) {
                ...
                getIPAddress { ipAddress in
                    ...
                    let headers = [
                        ...
                        "apikeyapp": "eOqS5zkEngCOLee8beWrCnp3",
                        "ip": self.bvdyfsgv ?? "",
